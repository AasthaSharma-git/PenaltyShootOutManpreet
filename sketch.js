...
function saves() {
  if (jump==1) {
    goalkeeper.position.x = goalkeeper.position.x + 15;
...
function shot() {
  if (keyDown("UP_ARROW") && shoot === 1) {
    ...
    football.attractionPoint ( 5,  125, height - 380)
  ...
  if (keyDown("LEFT_ARROW") && shoot === 1) {
    ...
    football.x = width / 2;
    football.y = height / 2 + 270;
    football.attractionPoint ( 5,  110, height - 200)
    console.log("up" + shoot);
    console.log(jump);
  }
  if (keyDown("RIGHT_ARROW") && shoot === 1) {
    ...
    football.x = width / 2;
    football.y = height / 2 + 270;
    football.attractionPoint ( 5,  600, height - 200)
    console.log("up" + shoot);
    console.log(jump);
  }
  ...
  if (keyDown("DOWN_ARROW") && shoot === 1) {
    ...
    football.x = width / 2;
    football.y = height / 2 + 270;
    football.attractionPoint ( 5,  590, height - 380)
    console.log("up" + shoot);
    jump=Math.round(random(1,4));
    console.log(jump);
  }
